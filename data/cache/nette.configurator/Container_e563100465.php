...
// source: phar:///home/khb-core/current/www/data/Hacktoberfest/php-structure/php-structure-check/vendor/phpstan/phpstan/phpstan/src/PhpDoc/../../conf/config.stubValidator.neon
// source: array
...
class Container_e563100465 extends _HumbugBox96739a27ace4\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0248']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				...
				'phar:///home/khb-core/current/www/data/Hacktoberfest/php-structure/php-structure-check/vendor/phpstan/phpstan/phpstan/src/PhpDoc/../../conf/config.stubValidator.neon',
			],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e563100465 $container)
			{
	...
	public function createService0248(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_e563100465
	{
		return $this;
	}
	...
	public function createServiceNodeScopeResolverClassReflector(): _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\ClassReflector
	{
	...
	public function createServiceStubClassReflector(): _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\ClassReflector
	{
		return new _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\ClassReflector($this->getService('stubSourceLocator'));
	}


	public function createServiceStubConstantReflector(): _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\ConstantReflector
	{
		return new _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\ConstantReflector(
	...
	public function createServiceStubFunctionReflector(): _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\FunctionReflector
	{
		return new _HumbugBox96739a27ace4\Roave\BetterReflection\Reflector\FunctionReflector(
			$this->getService('stubSourceLocator'),
			$this->getService('stubClassReflector')
		);
	}
	...
	public function createServiceStubSourceLocator(): _HumbugBox96739a27ace4\Roave\BetterReflection\SourceLocator\Type\SourceLocator
	{
